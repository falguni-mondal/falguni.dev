...
const Project = (props) => {
  ...
  return (
    <li onMouseEnter={() => projectRevealer(`.${name.split(" ").join("")}`)} onMouseLeave={() => projectUnRevealer(`.${name.split(" ").join("")}`)} className='project relative w-full flex flex-col justify-center pb-5 pt-10 lg:pb-10 border-b border-zinc-700'>
