import falguni from '../assets/mine/falguni-min.jpg'
  ...
  return (
    <section id='hero' className='hero-section flex flex-col py-[5vh] w-full pt-[12vh]'>
      ...
      <div className='my-info relative top-[-5vh] w-[95%] h-[40vh] rotate-3 flex justify-center items-center  mx-auto'>
        <img className='my-img w-full h-full object-cover object-center rounded-lg shadow-2xl shadow-[rgba(39,223,179,0.15)]' src={falguni-min} alt="" />
      </div>
      <Socials />
    </section>
  )
